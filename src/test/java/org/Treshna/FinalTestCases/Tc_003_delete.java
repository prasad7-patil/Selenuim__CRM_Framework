...
public class Tc_003_delete extends BaseClass {
	...
	public  void deleteOrganization(Method mtd) throws InterruptedException {
		...
		String dropdownvalue = excelUtility.getDataFromDataFromExcel("organization", mtd.getName(), "dropdownValue");
		...
		createNewOrganizationPage.createOrganization(ExpectedOrganizationName, PhoneNumber, webDriverUtility, dropdownvalue);
